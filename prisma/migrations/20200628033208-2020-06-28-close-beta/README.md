# Migration `20200628033208-2020-06-28-close-beta`

This migration has been generated by wwlee94 at 6/28/2020, 3:32:08 AM.
You can check out the [state of the schema](./schema.prisma) after the migration.

## Database Steps

```sql
ALTER TABLE `habit_bread_prod`.`items` DROP COLUMN `img`;
```
