# Migration `20200627201036-2020-06-27-close-beta`

This migration has been generated by dnatuna at 6/27/2020, 8:10:36 PM.
You can check out the [state of the schema](./schema.prisma) after the migration.

## Database Steps

```sql
ALTER TABLE `habit_bread`.`habits` ADD COLUMN `description` varchar(191)   ;
```
